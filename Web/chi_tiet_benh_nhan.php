...
include "../db.php";
$id = $_GET['id'];
$benhnhan = sqlsrv_fetch_array(sqlsrv_query($conn, "SELECT * FROM BenhNhan,NguoiDung WHERE BenhNhan.IDBenhNhan = NguoiDung.IDNguoiDung AND IDNguoiDung = $id"))
log
?>
                            ...
                            <div id="account-details-vertical" class="content" role="tabpanel" aria-labelledby="account-details-vertical-trigger">
                                ...
                                <div class="row">
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <input type="text" id="fullname" class="form-control"  value="<?php echo $benhnhan['ovaten'] ?>" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-1 form-password-toggle col-md-6">
                                        ...
                                        <select  class="form-select" id="gender">
                                            ...
                                            <option echo $benhnhan['GioiTinh] == 1 ? "selected" : "" value="1">Nam</option>
                                            <option  echo $benhnhan['GioiTinh] == 0 ? "selected" : "" value="0">Nữ</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-1 col-md-12">
                                            <textarea class="form-control" placeholder="Nhập lưu ý" rows="5" id="note"><? echo</textarea>
    ...
    <script>
        ...
        $(document).ready(function(){
            //load room
            $.ajax({ url: "http://52.231.106.103/api/admin/fetch_room.php",
            ...
            $('#room').on('change', function (e) {
                ...
                $room_id = $('#room').val();
                $.ajax({ url: "http://52.231.106.103/api/admin/fetch_bed.php",
                    context: document.body,
                    dataType: 'json',
                    type : 'post',
            ...
            $.ajax({ url: "http://52.231.106.103/api/admin/fetch_province.php",
                context: document.body,
                dataType: 'json',
                success: function(data){
                    $.each(data, function (index, value) {
            ...
            $('#province').on('change', function (e) {
                ...
                $.ajax({ url: "http://52.231.106.103/api/admin/fetch_district.php",
                    context: document.body,
                    dataType: 'json',
                    type : 'post',
            ...
            $('#district').on('change', function (e) {
                ...
                $.ajax({ url: "http://52.231.106.103/api/admin/fetch_ward.php",
                    context: document.body,
                    dataType: 'json',
                    type : 'post',
...
//'$fullname','$dob','$phone',$gender,'$national',$status,'$bed','$id','$ward','$detail','$id_phieu','N','Nhập viện bệnh nhân','1','50' */
                $.ajax({ url: "http://52.231.106.103/api/admin/add_victim.php",
                    context: document.body,
                    dataType: 'json',
                    type : 'post',
                    data: {
