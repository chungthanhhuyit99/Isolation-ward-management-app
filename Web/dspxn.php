            ...
            <section class="invoice-list-wrapper">
                ...
                <div class="card">
                    <div class="card-body border-bottom">
                        ...
                        <h4 class="card-title">Danh sách phiếu xét nghiệm</h4>
                        <div class="row">
                    ...
                    <div class="table-responsive">
                        <table id="victim_list" class="table">
                            ...
                            <tr>
                                ...
                                <th>PCR</th>
                                <th>Chỉ số CT</th>
                                <th class="text-truncate">Ngày xét nghiệm</th>
                                <th class="text-truncate">Ngày trả kết quả</th>
                                <th>Kết luận</th>
                                <th></th>
                                <th></th>
                            </tr>
...
<script>
    ...
    $('#victim_list').DataTable({
        ajax: 'http://20.39.185.180/api/admin/get_ds_pxn.php?id='+$id,
        language: {
        ...
        columns: [
            ...
            {data: 'IDPhieu'},
            {
                'data': null, wrap: true, "render": function (item) {
                    return item.PCR == 1 ? "Dương tính" :"Âm tính"
                }
            },
            {data: 'ChiSoCT'},
            {data: 'NgayLayMau.date'},
            {data: 'NgayTraKetQua.date'},
            {
                'data': null, wrap: true, "render": function (item) {
                    return item.KetQuaXetNghiem == 1 ? "Dương tính" :"Âm tính"
                }
            },
            {
                'data': null, wrap: true, "render": function (item) {
                    return '<a href="chitiet_pxn.php?id=' + item.IDPhieu + '"><button type="button"  class="btn btn-success">Xem chi tiết</button></a>'
                }
            },
            {
                'data': null, wrap: true, "render": function (item) {
    ...
    function deleteThis(e){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                //ajax
                $.ajax({ url: "http://20.39.185.180/api/admin/delete_pxn.php",
