...
<script>
    ...
    $('#victim_list').DataTable({
        ...
        columns: [
            ...
            {
                'data': null, wrap: true, "render": function (item) {
                    return '<a href="them-phieu-xet-nghiem.php/?id=' + item.IDBenhNhan + '"><button type="button"  class="btn btn-success">Thêm phiếu</button></a>'
                }
            },
            {
                'data': null, wrap: true, "render": function (item) {
                    return '<a href="dspxn.php?id=' + item.IDBenhNhan + '"><button type="button"  class="btn btn-success" >Xem danh sách</button></a>'
                }
            },
        ],
