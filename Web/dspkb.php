            ...
            <section class="invoice-list-wrapper">
                ...
                <div class="card">
                    <div class="card-body border-bottom">
                        ...
                        <h4 class="card-title">Danh sách phiếu khám bệnh</h4>
                        <div class="row">
                    ...
                    <div class="table-responsive">
                        <table id="victim_list" class="table">
                            ...
                            <tr>
                                ...
                                <th>Hình thức</th>
                                <th>Tổng quan</th>
                                <th class="text-truncate">Ngày khám</th>
                                <th>Kết luận</th>
                                <th></th>
                                <th></th>
                            </tr>
...
<script>
    ...
    $('#victim_list').DataTable({
        ajax: 'http://20.39.185.180/api/admin/get_ds_pkb.php?id='+$id,
        language: {
        ...
        columns: [
            ...
            {data: 'IDPhieu'},
            {
                'data': null, wrap: true, "render": function (item) {
                    return item.KhamDinhKy == 1 ? "Định kỳ" :"Khẩn cấp"
                }
            },
            {data: 'TongQuan'},
            {data: 'NgayKham.date'},
            ...
            {
                'data': null, wrap: true, "render": function (item) {
                    return '<a href="chitiet_pkb.php?id=' + item.IDPhieu + '"><button type="button"  class="btn btn-success">Xem chi tiết</button></a>'
                }
            },
            {
                'data': null, wrap: true, "render": function (item) {
    ...
    function deleteThis(e){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                //ajax
                $.ajax({ url: "http://20.39.185.180/api/admin/delete_pkb.php",
